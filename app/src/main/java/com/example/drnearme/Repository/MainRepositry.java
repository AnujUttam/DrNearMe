package com.example.drnearme.Repository;
    ...
    public LiveData<List<CategoryModel>> loadCategory(){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot childSnapsot : snapshot.getChildren()){
                    CategoryModel item = childSnapsot.getValue(CategoryModel.class);
                    if(item != null){
                        lists.add(item);
                    }
                }
    ...
    public LiveData<List<DoctorsModel>> load(){
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot childSnapsot : snapshot.getChildren()){
                    DoctorsModel item = childSnapsot.getValue(DoctorsModel.class);
                    if(item != null){
                        lists.add(item);
                    }
                }
